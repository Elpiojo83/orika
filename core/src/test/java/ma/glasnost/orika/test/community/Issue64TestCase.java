 ...
 *
 * @see <a
 *     href="https://code.google.com/archive/p/orika/issues/64">https://code.google.com/archive/p/orika/</a>
 */
public class Issue64TestCase {
  ...
  public void mapWithConstructor() {
    ...
    for (int i = 0; i < supplier.getAddresses().size(); ++i) {
      Assert.assertEquals(
          supplier.getAddresses().get(i).street, result.getAddresses().get(i).street);
      Assert.assertEquals(supplier.getAddresses().get(i).city, result.getAddresses().get(i).city);
      Assert.assertEquals(
          supplier.getAddresses().get(i).country, result.getAddresses().get(i).country);
      Assert.assertEquals(
          supplier.getAddresses().get(i).postalCode, result.getAddresses().get(i).postalCode);
    }
