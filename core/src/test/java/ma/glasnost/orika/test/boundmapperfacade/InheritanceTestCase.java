...
public class InheritanceTestCase {
  ...
  public void testSimpleInheritance() {
    ...
    BoundMapperFacade<ChildEntity, ChildDTO> mapper =
        factory.getMapperFacade(ChildEntity.class, ChildDTO.class);
  ...
  public void resolveConcreteClass() {
    BoundMapperFacade<ChildEntity, BaseDTO> mapper =
        factory.getMapperFacade(ChildEntity.class, BaseDTO.class);
  ...
  public void testDifferentLevelOfInheritance() {
    factory.registerClassMap(
        factory
            .classMap(ChildEntity.class, Child2DTO.class)
            .customize(
                new CustomMapper<ChildEntity, Child2DTO>() {
    ...
    BoundMapperFacade<ChildEntity, Child2DTO> mapper =
        factory.getMapperFacade(ChildEntity.class, Child2DTO.class);
  ...
  public abstract static class BaseDTO {
    private Long id;
