 ...
 *
 * @see <a
 *     href="https://code.google.com/archive/p/orika/issues/46">https://code.google.com/archive/p/orika/</a>
 */
  ...
  public void test() {
    ...
    try {
      for (Parent parent : parents) {
        ...
        for (One one : result.oneList) for (Two two : one.twos) Assert.assertNotNull(two.getName());
      }
    } catch (Exception e) {
      throw new AssertionError(
          "Failed to process graph. failed after " + transforms + " transforms, exception = " + e);
    }
  }
