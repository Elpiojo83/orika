...
public class SuperTypeMappingTestCase {
  ...
  public void testMappingInterfaceImplementationWithExistingDirectMapping() throws Exception {
    ...
    factory
        .classMap(Library.class, LibraryMyDTO.class)
        .field("title", "myTitle")
        .field("books", "myBooks")
        .byDefault()
        .register();
    ...
    factory
        .classMap(Author.class, AuthorMyDTO.class)
        .field("name", "myName")
        .byDefault()
        .register();

    factory
        .classMap(Book.class, BookMyDTO.class)
        .field("title", "myTitle")
  ...
  public void testMappingSubclassImplementationWithoutExistingMapping() throws Exception {
    ...
    DefaultFieldMapper myDefaultFieldMapper =
  ...
  public void testMappingSubclassImplementationWithExistingMapping() throws Exception {
    ...
    factory.registerClassMap(
        factory
            .classMap(AuthorParent.class, AuthorMyDTO.class)
            .field("name", "myName")
            .byDefault()
            .toClassMap());
    factory.registerClassMap(
        factory
            .classMap(BookParent.class, BookMyDTO.class)
            .field("title", "myTitle")
            .field("author", "myAuthor")
            .byDefault()
            .toClassMap());
  ...
  public void testSuperTypeForInaccessibleClassWithAccessibleSupertype() throws Exception {
    ...
    ClassLoader childLoader = TestUtil.getJavaSourceClassLoader(threadContextLoader);
