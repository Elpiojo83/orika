...
public class PropertyResolverTestCase {
  ...
  public void testIsNestedProperty() {
    ...
    String inlineProp1 =
        "points:{getAttribute('points')|setAttribute('points', %s)|type=ma.glasnost.orika.test.property.PropertyResolverTestCase.Point}";
    ...
    String inlineProp2 =
        "points:{getAttribute('points')|setAttribute('points', %s)|type=List<ma.glasnost.orika.test.property.PropertyResolverTestCase.Point>}";
  ...
  public void testAdHocResolution() {
    ...
    Property prop =
        propertyResolver.getProperty(
            A.class, "name:{readTheNameForThisBean|assignTheName}.firstName");
  ...
  public void testAdHocResolutionGetterOnly() {
    ...
    Property prop =
        propertyResolver.getProperty(A.class, "name:{readTheNameForThisBean}.firstName");
  ...
  public void testAdHocResolution_withType() {
    ...
    Property prop =
        propertyResolver.getProperty(
            A.class,
            "name:{readTheNameForThisBean|assignTheName|type=ma.glasnost.orika.test.property.TestCaseClasses$Name}.firstName");
  ...
  public void testAdHocResolutionGetterOnly_withType() {
    ...
    Property prop =
        propertyResolver.getProperty(
            A.class,
            "name:{readTheNameForThisBean|type=ma.glasnost.orika.test.property.TestCaseClasses$Name}.firstName");
  ...
  public void testAdHocResolutionSetterOnly_withType() {
    ...
    Property prop =
        propertyResolver.getProperty(
            A.class,
            "name:{|assignTheName|type=ma.glasnost.orika.test.property.TestCaseClasses$Name}.firstName");
  ...
  public void testAdHocResolution_integration() {
    ...
    ma.glasnost.orika.test.property.TestCaseClasses.Address address =
        new ma.glasnost.orika.test.property.TestCaseClasses.Address();
  ...
  /**
   * This test case verifies that an ad-hoc property definition can be reused so that it doesn't
   * have to be repeated in subsequent lines
   */
  @Test
  ...
  /**
   * This test case verifies that properties can be added through a programmatic builder interface,
   * explicitly defining the properties using the programming API.
   */
  @Test
  public void testAdHocResolution_integration_programmaticPropertyBuilder() {
    ...
    Assert.assertEquals(
        ((Element) person.getAttribute("name")).getAttribute("first"), result.firstName);
    Assert.assertEquals(
        ((Element) person.getAttribute("name")).getAttribute("last"), result.lastName);
    Assert.assertEquals(
        ((Element) person.getAttribute("employment")).getAttribute("salary"), result.salary);
    Assert.assertEquals(
        ((Element) person.getAttribute("employment")).getAttribute("jobTitle"), result.jobTitles);
  }

  /**
   * Demonstrates that you can declare properties in-line using a custom property descriptor format;
   * like so: "propertyName{getterName|setterName|type=the.type.Name}" setter and type name are
   * optional although those arguments must be constants;
   */
  @Test
  public void testAdHocResolution_integration_declarativeProperties() {
...

    {
      ...
      String jobTitleDef =
          "jobTitle:{getAttribute(\"jobTitle\")|setAttribute(\"jobTitle\", %s)|type=java.util.List}";
      String salaryDef =
      ...
      String firstNameDef =
          "first:{getAttribute(\"first\")|setAttribute(\"first\", %s)|type=java.lang.String}";
      String lastNameDef =
          "last:{getAttribute(\"last\")|setAttribute(\"last\", %s)|type=java.lang.String}";

      factory
          .classMap(Element.class, PersonDto.class)
    ...
    Assert.assertEquals(
        ((Element) person.getAttribute("name")).getAttribute("first"),
        ((Element) mapBack.getAttribute("name")).getAttribute("first"));
    Assert.assertEquals(
        ((Element) person.getAttribute("name")).getAttribute("last"),
        ((Element) mapBack.getAttribute("name")).getAttribute("last"));
    Assert.assertEquals(
        ((Element) person.getAttribute("employment")).getAttribute("salary"),
        ((Element) mapBack.getAttribute("employment")).getAttribute("salary"));

    List<?> original =
        (List<?>) ((Element) person.getAttribute("employment")).getAttribute("jobTitle");
    List<?> mapBackList =
        (List<?>) ((Element) mapBack.getAttribute("employment")).getAttribute("jobTitle");
    Assert.assertTrue(original.containsAll(mapBackList));
    Assert.assertTrue(mapBackList.containsAll(original));
  }

  /**
   * Demonstrates that you can specify the types as parameterized if necessary, such as
   * "List&lt;String&gt;" or "java.util.List&lt;java.lang.String&gt;"
   */
  @Test
  public void testAdHocResolution_integration_declarativePropertiesNestedTypes() {
...

    {
      String employmentDef =
          "employment:{getAttribute(\"employment\")|setAttribute(\"employment\", %s)|type=ma.glasnost.orika.test.property.PropertyResolverTestCase$Element}";
      String jobTitleDef =
          "jobTitle:{getAttribute(\"jobTitle\")|setAttribute(\"jobTitle\", %s)|type=List<String>}";
      String salaryDef =
          "salary:{getAttribute(\"salary\")|setAttribute(\"salary\", %s)|type=java.lang.Long}";
      ...
      factory
          ...
          .field(employmentDef + "." + jobTitleDef, "jobTitles")
          .field(
              "employment." + salaryDef,
              "salary") // reuse the in-line declaration of 'employment' property
          .field(nameDef + "." + firstNameDef, "firstName")
          .field(
              "name." + lastNameDef,
              "lastName") // reuses the in-line declaration of 'name' property
          .register();
    }
  ...
  /**
   * Demonstrates that you can specify the types as parameterized if necessary, such as
   * "List&lt;String&gt;" or "java.util.List&lt;java.lang.String&gt;", and that single quotes can be
   * used instead of double quotes for convenience.
   */
  @Test
  public void testAdHocResolution_integration_declarativePropertiesNestedTypesSingleQuote() {
    ...
    Assert.assertEquals(
        ((Element) person.getAttribute("employment")).getAttribute("'salary'"), result.salary);
    Assert.assertEquals(
        ((Element) person.getAttribute("employment")).getAttribute("job's Title"),
        result.jobTitles);
    ...
    List<?> original =
        (List<?>) ((Element) person.getAttribute("employment")).getAttribute("job's Title");
    List<?> mapBackList =
        (List<?>) ((Element) mapBack.getAttribute("employment")).getAttribute("job's Title");
    Assert.assertTrue(original.containsAll(mapBackList));
    Assert.assertTrue(mapBackList.containsAll(original));
  }
  ...
  public void resolveParameterizedTypeFromAncestor() {
    ...
    Type<?> expectedType = new TypeBuilder<Map<String, Element>>() {}.build();
  ...
  public abstract static class AbstractOrderedMap<K, T> implements Iterable<T>, Serializable {
  ...
  /**
   * This type is not itself a parameterized type, but it extends from one, and those parameters
   * should be resolved in properties' types.
   */
