...
public class InverseMappingTestCase {
  ...
  public void testInverseOneToOneMapping() {
    ...
    ClassMapBuilder<PersonDTO, Person> classMapBuilder =
  ...
  public void testInverseOneToManyMapping() {
    ...
    ClassMapBuilder<PublisherDTO, Publisher> classMapBuilder =
        factory.classMap(PublisherDTO.class, Publisher.class);
    classMapBuilder.fieldMap("books").bInverse("publisher").add();
    factory.registerClassMap(classMapBuilder.byDefault().toClassMap());

    BoundMapperFacade<Publisher, PublisherDTO> mapper =
        factory.getMapperFacade(Publisher.class, PublisherDTO.class);
  ...
  public void testInverseManyToManyMapping() {
    ...
    ClassMapBuilder<ReaderDTO, Reader> classMapBuilder =
        factory.classMap(ReaderDTO.class, Reader.class);
    classMapBuilder.fieldMap("books").bInverse("readers").add();
    factory.registerClassMap(classMapBuilder.byDefault().toClassMap());

    BoundMapperFacade<Reader, ReaderDTO> mapper =
        factory.getMapperFacade(Reader.class, ReaderDTO.class);
    BoundMapperFacade<ReaderDTO, Reader> mapper2 =
        factory.getMapperFacade(ReaderDTO.class, Reader.class);
