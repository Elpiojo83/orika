 ...
 *
 * @see <a
 *     href="https://code.google.com/archive/p/orika/issues/25">https://code.google.com/archive/p/orika/</a>
 */
public class Issue25TestCase extends BaseManufacturingFacilityTest {
  ...
  public void testMapManufacuringFacilityToDTS() {
    Map<String, Object> betriebsstaetteMap = getManufacturingFacility(1L, "First");

    ManufacturingFacility manufacturingFacility =
        (ManufacturingFacility)
            betriebsstaetteMap.get(BaseManufacturingFacilityTest.MANUFACTURINGFACILITY_KEY);
    ManufacturingFacilityDTS manufacturingFacilityDTS =
        (ManufacturingFacilityDTS)
            betriebsstaetteMap.get(BaseManufacturingFacilityTest.MANUFACTURINGFACILITYDTS_KEY);

    addAddressToManufacturingFacility(
        betriebsstaetteMap, 1L, "Beispielstra�e 2", 815L, "This is a comment.", 'D');

    ManufacturingFacilityDTS betriebsstaetteDTSMapped =
        mapper.map(manufacturingFacility, ManufacturingFacilityDTS.class);
    ManufacturingFacility betriebsstaetteMappedBack =
        mapper.map(betriebsstaetteDTSMapped, ManufacturingFacility.class);
    assertThat(manufacturingFacility, is(betriebsstaetteMappedBack));
  }

  @Test
  public void testMapManufacuringFacilityToDTSNullValues() {
    Map<String, Object> betriebsstaetteMap = getManufacturingFacility(2L, "Second");
    ...
    addAddressToManufacturingFacility(
        betriebsstaetteMap, 1L, null, 815L, "This is a comment.", 'D');
  ...
  public void testMapManufacuringFacilityToDTSMultipleAdr() {
    Map<String, Object> betriebsstaetteMap = getManufacturingFacility(3L, "First");
    ...
    addAddressToManufacturingFacility(
        betriebsstaetteMap, 10L, "StreetA", 815L, "This is a comment. 10", 'D');
    addAddressToManufacturingFacility(
        betriebsstaetteMap, 11L, "StreetB", 816L, "This is a comment. 11", 'E');
    addAddressToManufacturingFacility(
        betriebsstaetteMap, 12L, "StreetC", 817L, "This is a comment. 12", 'F');
  ...
  public void testMapManufacuringFacilityToDTSMerge() {
    ...
    ManufacturingFacilityDTS manufacturingFacilityDTSServer =
        mapper.map(manufacturingFacility, ManufacturingFacilityDTS.class);
    ...
    ManufacturingFacility manufacturingFacilityToEdit =
        mapper.map(manufacturingFacilityDTSServer, ManufacturingFacility.class);
    ...
    assertThat(
        "An address was removed. In the merged DS this address does still exist.",
        addressesFromPrototype.size(),
        is(2));
