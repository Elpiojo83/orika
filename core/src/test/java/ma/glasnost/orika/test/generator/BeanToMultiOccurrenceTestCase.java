...
public class BeanToMultiOccurrenceTestCase {
  ...
  public void unequalSize() throws Exception {
    ...
    factory.registerClassMap(
        factory
            .classMap(MapOfScores.class, GenericDto.class)
  ...
  public void parallelWithConvertedTypes() throws Exception {
    ...
    factory.registerClassMap(
        factory
            .classMap(MapOfPeople.class, GenericDto.class)
    ...
    for (Person person : peopleMap.people.values()) {
      ...
      Assert.assertTrue(
          toXMLGregorianCalendar(result.dateArray[i], dataTypeFactory)
              .toXMLFormat()
  ...
  /**
   * Verifies that we're able to map from a single to field to each of the individual elements of a
   * multi-occurrence item
   *
   * @throws Exception
   */
  @Test
  public void oneToMany() throws Exception {
    ...
    factory.registerClassMap(
        factory
            .classMap(GroupOfStudents.class, MapOfStudents.class)
