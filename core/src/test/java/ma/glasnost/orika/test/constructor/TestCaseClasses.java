...
public interface TestCaseClasses {
  ...
  public static class PersonVO3 {
    ...
    public PersonVO3(String firstName, String lastName, Date dateOfBirth) {
      this(
          firstName,
          lastName,
          yearsDifference(dateOfBirth, new Date()),
  ...
  public class NestedPrimitiveHolder {
    ...
    public NestedPrimitiveHolder(
        PrimitiveNumberHolder numbers, char charValue, boolean booleanValue, byte byteValue) {
      super();
    ...
    public String toString() {
      return "NestedPrimitiveHolder [charValue="
          + charValue
          + ", booleanValue="
          + booleanValue
          + ", byteValue="
  ...
  public class PrimitiveNumberHolder {
    ...
    public PrimitiveNumberHolder(
        short shortValue, int intValue, long longValue, float floatValue, double doubleValue) {
      super();
    ...
    @Override
    public String toString() {
      return "PrimitiveNumberHolder [shortValue="
          + shortValue
          + ", intValue="
          + intValue
          + ", longValue="
