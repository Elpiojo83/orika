...
public abstract class AbstractOrderID {
  ...
  public int hashCode() {
    final int prime = 31;
    int result = 1;
    result = prime * result + ((bestellungID == null) ? 0 : bestellungID.hashCode());
    return result;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (bestellungID == null) {
      if (other.bestellungID != null) return false;
    } else if (!bestellungID.equals(other.bestellungID)) return false;
    return true;
  }
}
