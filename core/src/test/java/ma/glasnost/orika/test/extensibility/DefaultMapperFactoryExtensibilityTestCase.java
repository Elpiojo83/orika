...
public class DefaultMapperFactoryExtensibilityTestCase {
  ...
  public void testExtendedMapper() {
    MyMapperFactory factory =
        new MyMapperFactory.Builder().useAutoMapping(true).traceMethodCalls(true).build();
  ...
  public static class MyMapperFactory extends DefaultMapperFactory {
    ...
    /**
     * We extend the builder of DefaultMapperFactory for one which can create instances of our own
     * MapperFactory type.
     */
    ...
    /**
     * TracingMapperFacade provides custom wrappers around MapperFacade which log all method calls
     * against it.
     */
    private static class TracingMapperFacade implements InvocationHandler {
      ...
      public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        try {
           ...
           */
          final String methodName = delegate.getClass().getCanonicalName() + "#" + method.getName();
