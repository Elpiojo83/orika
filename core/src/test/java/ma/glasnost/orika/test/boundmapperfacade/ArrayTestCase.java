...
public class ArrayTestCase {
  ...
  public void testSimplePrimitiveArray() {
    ...
    BoundMapperFacade<A, B> mapperFacade =
        MappingUtil.getMapperFactory()
            .getMapperFacade(ArrayTestCaseClasses.A.class, ArrayTestCaseClasses.B.class);
  ...
  public void testSimplePrimitiveToWrapperArray() {
    ...
    BoundMapperFacade<A, C> mapperFacade =
        MappingUtil.getMapperFactory().getMapperFacade(A.class, C.class);
  ...
  public void testArrayToList() {
    BoundMapperFacade<A, D> mapperFacade =
        MappingUtil.getMapperFactory().getMapperFacade(A.class, D.class);
  ...
  public void testMappingArrayOfString() {
    ...
    ProductDTO productDTO =
        MappingUtil.getMapperFactory().getMapperFacade(Product.class, ProductDTO.class).map(p);
