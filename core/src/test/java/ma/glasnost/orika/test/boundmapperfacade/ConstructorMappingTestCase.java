...
public class ConstructorMappingTestCase {
  ...
  public void testSimpleCase() throws Throwable {
    ...
    factory
        .classMap(PersonVO.class, Person.class)
        // .constructorA()
    ...
    factory
        .getConverterFactory()
        .registerConverter(DATE_CONVERTER, new DateToStringConverter(DATE_PATTERN));
  ...
  public void testFindConstructor() throws Throwable {
    ...
    factory
        .classMap(PersonVO3.class, Person.class)
        .fieldMap("dateOfBirth", "date")
        .converter(DATE_CONVERTER)
        .add()
        .byDefault()
  ...
  public void testAutomaticCaseWithHint() throws Throwable {
    ...
    factory.registerDefaultFieldMapper(
  ...
  public void testPrimitiveToPrimitiveTypes() {
    ...
    PrimitiveHolderDTO dto =
        factory.getMapperFacade().map(primitiveHolder, PrimitiveHolderDTO.class);
  ...
  public void testPrimitiveToWrapperTypes() {
    ...
    PrimitiveWrapperHolder wrapper =
        factory.getMapperFacade().map(primitiveHolder, PrimitiveWrapperHolder.class);
  ...
  public void testWrapperToWrapperTypes() {
    ...
    PrimitiveWrapperHolderDTO dto =
        factory.getMapperFacade().map(primitiveHolder, PrimitiveWrapperHolderDTO.class);

    assertValidMapping(primitiveHolder, dto);

    PrimitiveWrapperHolder mapBack =
        factory.getMapperFacade().map(dto, PrimitiveWrapperHolder.class);
  ...
  public void testMappingNestedTypes() {
    ...
    MapperFactory factory = MappingUtil.getMapperFactory();
    factory
        .classMap(AuthorNested.class, AuthorDTO.class)
  ...
  public void testComplexMappingNestedTypes() {
    ...
    PrimitiveNumberHolder numbers =
        new PrimitiveNumberHolder(
            Short.MAX_VALUE, Integer.MAX_VALUE, Long.MAX_VALUE, Float.MAX_VALUE, Double.MAX_VALUE);

    NestedPrimitiveHolder primitiveHolder =
        new NestedPrimitiveHolder(numbers, Character.MAX_VALUE, Boolean.TRUE, Byte.MAX_VALUE);
    ...
    factory
        .classMap(NestedPrimitiveHolder.class, PrimitiveWrapperHolder.class)
  ...
  public void testConstructorsWithoutDebugInfo() {
    ...
    factory.registerClassMap(
        factory
            .classMap(URLDto1.class, URL.class)
  ...
  private void assertValidMapping(
      PrimitiveWrapperHolder primitiveHolder, PrimitiveWrapperHolderDTO dto) {
    assertEquals(primitiveHolder.getShortValue(), dto.getShortValue());
    assertEquals(primitiveHolder.getIntValue(), dto.getIntValue());
    assertEquals(primitiveHolder.getLongValue(), dto.getLongValue());
    assertEquals(primitiveHolder.getFloatValue(), dto.getFloatValue(), 1.0f);
