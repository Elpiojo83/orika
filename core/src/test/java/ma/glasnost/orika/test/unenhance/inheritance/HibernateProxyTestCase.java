...
public class HibernateProxyTestCase {
  ...
  private MapperFacade buildMapper() {
    ...
    mf.registerClassMap(
        mf.classMap(Sub1Entity.class, Sub1EntityDTO.class)
            .use(AbstractEntity.class, AbstractDTO.class)
            .byDefault()
            .toClassMap());
    mf.registerClassMap(
        mf.classMap(Sub2Entity.class, Sub2EntityDTO.class)
            .use(AbstractEntity.class, AbstractDTO.class)
            .byDefault()
            .toClassMap());
  ...
  public void testMappingNonProxyObject() {
    ...
    Sub2Entity sub2 = (Sub2Entity) getSession().get(Sub2Entity.class, sub21Id);
    sub2.setReferences(
        (MyEntity)
            ((HibernateProxy) sub2.getReferences())
    ...
    Assert.assertEquals(
        sub2.getReferences().getMyProperty(), sub2Dto.getReferences().getMyProperty());
    Assert.assertEquals(Sub1EntityDTO.class, sub2Dto.getReferences().getClass());
    Assert.assertEquals(1, ((Sub1EntityDTO) sub2Dto.getReferences()).getSub1Property());
  }
  ...
  public void testMappingCaching() {
    ...
    Sub2Entity sub22 = (Sub2Entity) getSession().get(Sub2Entity.class, sub22Id);
    Sub2Entity sub21 = (Sub2Entity) getSession().get(Sub2Entity.class, sub21Id);
  ...
  public void testMappingCollections() {
    ...
    List<MyEntity> entities =
        Arrays.asList(
            (MyEntity) getSession().load(MyEntity.class, sub22Id),
