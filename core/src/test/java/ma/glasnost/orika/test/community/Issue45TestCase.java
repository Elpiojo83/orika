 ...
 *
 * @see <a
 *     href="https://code.google.com/archive/p/orika/issues/45">https://code.google.com/archive/p/orika/</a>
 */
public class Issue45TestCase {
  ...
  private static class MyMapper extends ConfigurableMapper {
    ...
    private static class SourceConverter extends CustomConverter<SourceChild, Dest1> {
      ...
      public Dest1 convert(
          SourceChild source, Type<? extends Dest1> destinationType, MappingContext context) {
