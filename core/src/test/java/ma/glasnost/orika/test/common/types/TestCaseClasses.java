...
public interface TestCaseClasses {
  ...
  public class PrimitiveHolder {
    ...
    public String toString() {
      return "PrimitiveHolder [shortValue="
          + shortValue
          + ", intValue="
          + intValue
          + ", longValue="
    ...
    public boolean equals(final Object other) {
      ...
      return Objects.equals(shortValue, castOther.shortValue)
          && Objects.equals(intValue, castOther.intValue)
  ...
  public class PrimitiveHolderDTO {
    ...
    @Override
    public String toString() {
      return "PrimitiveHolderDTO [shortValue="
          + shortValue
          + ", intValue="
          + intValue
          + ", longValue="
  ...
  public class PrimitiveWrapperHolder {
    ...
    @Override
    public String toString() {
      return "PrimitiveWrapperHolder [shortValue="
          + shortValue
          + ", intValue="
          + intValue
          + ", longValue="
  ...
  public class PrimitiveWrapperHolderDTO {
    ...
    @Override
    public String toString() {
      return "PrimitiveWrapperHolderDTO [shortValue="
          + shortValue
          + ", intValue="
          + intValue
          + ", longValue="
  ...
  public class Name {
    ...
    public boolean equals(final Object other) {
      ...
      return Objects.equals(firstName, castOther.firstName)
  ...
  public class BookDTO {
    ...
    public boolean equals(final Object other) {
      ...
      return Objects.equals(title, castOther.title)
          && Objects.equals(author, castOther.author)
          && Objects.equals(additionalValue, castOther.additionalValue);
    }
  ...
  public class LibraryDTO {
    ...
    public boolean equals(final Object other) {
      ...
      return Objects.equals(title, castOther.title)
          && Objects.equals(books, castOther.books)
          && Objects.equals(additionalValue, castOther.additionalValue);
    }
