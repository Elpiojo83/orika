...
public class InitializeUsedMappersTestCase {
  ...
  public void testParentLookup() {
    ...
    factory.registerClassMap(
        factory.classMap(B2.class, A2.class).use(B1.class, A1.class).byDefault());
    factory.registerClassMap(factory.classMap(A1.class, B1.class).byDefault());
  ...
  public void testParentPropertiesSetOnce() {
    ...
    factory.registerClassMap(factory.classMap(ABase.class, BBase.class).byDefault());
    factory.registerClassMap(factory.classMap(ASub.class, BSub.class).byDefault());
