...
public class NestedInheritanceTestCase {
  ...
  public void testNestedInheritance() {
    ...
    factory.registerClassMap(
        factory.classMap(Person.class, PersonDTO.class).byDefault().toClassMap());
    factory.registerClassMap(
        factory.classMap(Client.class, ClientDTO.class).byDefault().toClassMap());
    factory.registerClassMap(
        factory
  ...
  public void testNestedPolymorphicInheritance() {
    ...
    factory.registerClassMap(
        factory.classMap(Client.class, ClientDTO.class).byDefault().toClassMap());
    factory.registerClassMap(
        factory.classMap(Employee.class, EmployeeDTO.class).byDefault().toClassMap());
    factory.registerClassMap(
        factory
            .classMap(Subscription.class, SubscriptionDTO.class)
            .field("client", "person")
    ...
    List<SubscriptionDTO> dto =
        factory.getMapperFacade().mapAsList(subscriptions, SubscriptionDTO.class);
