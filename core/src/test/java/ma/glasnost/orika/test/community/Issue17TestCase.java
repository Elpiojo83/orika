 ...
 *
 * @see <a
 *     href="https://code.google.com/archive/p/orika/issues/17">https://code.google.com/archive/p/orika/</a>
 */
        ...
        .registerConverter(
            new BidirectionalConverter<Integer, String>() {
              ...
              public String convertTo(
                  Integer source, Type<String> destinationType, MappingContext context) {
                return "" + source;
              }

              @Override
              public Integer convertFrom(
                  String source, Type<Integer> destinationType, MappingContext context) {
