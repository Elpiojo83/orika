...
public class CustomMergerTest {
  ...
  private static MapperFacade createMapperFacade() {
    ...
    factory.registerConcreteType(
        new TypeBuilder<Collection<Entity>>() {}.build(),
  ...
  public static class MergingMapper extends CustomMapper<Collection<Dto>, Collection<Entity>> {
    ...
    private Collection<Entity> merge(
        Collection<Dto> srcDtos, Collection<Entity> dstEntities, MappingContext context) {
