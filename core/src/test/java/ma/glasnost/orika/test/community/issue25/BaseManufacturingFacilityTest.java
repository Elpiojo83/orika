...
public abstract class BaseManufacturingFacilityTest {
  ...
  public void addAddressToManufacturingFacility(
    ...
    ManufacturingFacility manufacturingFacility =
        (ManufacturingFacility) betriebsstaetteMap.get(MANUFACTURINGFACILITY_KEY);
    ManufacturingFacilityDTS manufacturingFacilityDTS =
        (ManufacturingFacilityDTS) betriebsstaetteMap.get(MANUFACTURINGFACILITYDTS_KEY);
