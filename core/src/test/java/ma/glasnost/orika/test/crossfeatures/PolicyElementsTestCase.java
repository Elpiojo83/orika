...
public class PolicyElementsTestCase {
  ...
  private void configureMapperFactory(MapperFactory factory) {
    ...
    factory.registerClassMap(
        factory.classMap(Policy.class, PolicyDTO.class).byDefault().toClassMap());
    factory.registerClassMap(
        factory.classMap(CustomerElement.class, CustomerElementDTO.class).byDefault().toClassMap());
    factory.registerClassMap(
        factory.classMap(ProductElement.class, ProductElementDTO.class).byDefault().toClassMap());
    factory.registerClassMap(
        factory.classMap(OtherElement.class, OtherElementDTO.class).byDefault().toClassMap());
    factory.registerClassMap(
        factory.classMap(OneOtherElement.class, OneOtherElementDTO.class).byDefault().toClassMap());
  }
