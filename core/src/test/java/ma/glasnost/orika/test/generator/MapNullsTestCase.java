...
public class MapNullsTestCase {
  ...
  public void mapNulls_True_ClassLevel() {
    ...
    mapperFactory.classMap(Container.class, Container2.class).mapNulls(true).byDefault().register();
  ...
  public void mapNulls_False_ClassLevel() {
    ...
    mapperFactory
        .classMap(Container.class, Container2.class)
        .mapNulls(false)
        .byDefault()
        .register();
