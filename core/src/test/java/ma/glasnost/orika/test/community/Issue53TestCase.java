 ...
 *
 * @see <a
 *     href="https://code.google.com/archive/p/orika/issues/53">https://code.google.com/archive/p/orika/</a>
 */
public class Issue53TestCase {
  ...
  public void subClassSetterOrikaTest() {
    final MapperFactory mapperFactory =
        MappingUtil.getMapperFactory(); /*new DefaultMapperFactory.Builder().build();*/
